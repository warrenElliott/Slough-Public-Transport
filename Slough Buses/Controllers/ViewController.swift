...
class TimetableVC: UIViewController, BusStopsAtLocationDelegate, UITableViewDelegate {
...
extension TimetableVC: MKMapViewDelegate{
...
extension TimetableVC: BusDeparturesManagerDelegate{
